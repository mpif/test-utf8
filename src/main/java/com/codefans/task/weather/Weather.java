...
public class Weather {
	...
	public static void main(String[] args) throws Exception {
		...
		Map<String, Map<String, String>> rootMap = JSONObject.fromObject(liveJson);

		System.out.println("liveJson: " + liveJson);
		System.out.println("rootMap: " + rootMap.toString());
		...
		String futureHtml = ParseUtils.getElementByAttr(url, "class", "weatherYubaoBox");
		...
		FileUtils.writeStringToFile(new File(System.getProperty("user.dir") + "/weatherforecast.txt"),
				file_data.toString(), "UTF-8");
	}
}
