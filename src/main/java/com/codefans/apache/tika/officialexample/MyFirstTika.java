package com.codefans.apache.tika.officialexample;

/*
 * @Author: Sean
 * @Time: 2015-07-02 16:46:18
 */
/**
...
public class MyFirstTika {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("The MIME type (based on MAGIC) is: [" + mimeRegistry.getMimeType(new File(filename)) + "]");
