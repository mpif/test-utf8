...
public class SearchCrawler implements Runnable {
	...
	// 执行实际的搜索操作
	public ArrayList<String> crawl(String startUrl, int maxUrls, String searchString, boolean limithost,
	...
	public static void main(String[] args) {
		SearchCrawler crawler = new SearchCrawler("http://blog.csdn.net/changemyself", 20, "java");
