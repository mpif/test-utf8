...
public class FileAttachmentSAXHandle extends DefaultHandler {

	private File resultFile = null;

	public FileAttachmentSAXHandle(File resultFile) {
	...
	// private static final String ATTACHMENT_CONTENT =
	// URI_TYPE+":"+TYPE_CONTENT;
	...
	public void startDocument() throws SAXException {
		try {
			printWriter = new PrintWriter(new BufferedWriter(new FileWriter(resultFile)));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
