...
public final class MediaType implements Comparable<MediaType>, Serializable {
	...
	/**
	 * Set of basic types with normalized "type/subtype" names. Used to optimize
	 * type lookup and to avoid having too many {@link MediaType} instances in
	 * memory.
	 */
	...
	/**
	 * Convenience method that returns an unmodifiable set that contains all the
	 * given media types.
	 *
	...
	/**
	 * Convenience method that parses the given media type strings and returns
	 * an unmodifiable set that contains all the parsed types.
	 *
	 * @since Apache Tika 1.2
	 * @param types
	 *            media type strings
	...
	/**
	 * Location of the "/" character separating the type and the subtype tokens
	 * in {@link #string}.
	 */
	 ...
	 * {@link #string} from possible parameters. Length of {@link #string} in
	...
	/**
	 * Returns the base form of the MediaType, excluding any parameters, such as
	...
	/**
	 * Returns an immutable sorted map of the parameters of this media type. The
	 * parameter names are guaranteed to be trimmed and in lower case.
	 *
