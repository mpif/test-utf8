...
public interface XMPMM {
	...
	/**
	 * A reference to the resource from which this one is derived. This should
	 * be a minimal reference, in which missing components can be assumed to be
	 * unchanged.
	 * 
	...
	/**
	 * An identifier for a specific incarnation of a resource, updated each time
	 * a file is saved.
	 */
	 ...
	 * resource is derived. For example, if you save a resource to a different
	 * format, then save that one to another format, each save operation should
	 * generate a new xmpMM:DocumentID that uniquely identifies the resource in
	...
	/**
	 * The rendition class name for this resource. This property should be
	 * absent or set to default for a resource that is not a derived rendition
	 */
	Property RENDITION_CLASS = Property.externalOpenChoise(PREFIX_ + "RenditionClass", "default", "draft", "low-res",
			"proof", "screen", "thumbnail");

	/**
	 * Can be used to provide additional rendition parameters that are too
	 * complex or verbose to encode in xmpMM:RenditionClass
	 */
