...
/**
 * XMP Exif TIFF schema. This is a collection of {@link Property property
 * definition} constants for the Exif TIFF properties defined in the XMP
 * standard.
 *
...
public interface TIFF {
	...
	/**
	 * "F-Number." The f-number is the focal length divided by the "effective"
	 * aperture diameter. It is a dimensionless number that is a measure of lens
	 * speed.
	 */
	...
	/**
	 * "The Orientation of the image." 1 = 0th row at top, 0th column at left 2
	 * = 0th row at top, 0th column at right 3 = 0th row at bottom, 0th column
	 * at right 4 = 0th row at bottom, 0th column at left 5 = 0th row at left,
	 * 0th column at top 6 = 0th row at right, 0th column at top 7 = 0th row at
	 * right, 0th column at bottom 8 = 0th row at left, 0th column at bottom
	 */
	...
	/**
	 * "Units used for Horizontal and Vertical Resolutions." One of "Inch" or
	 * "cm"
	 */
