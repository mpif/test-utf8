...
/**
 * XMP Dynamic Media schema. This is a collection of {@link Property property
 * definition} constants for the dynamic media properties defined in the XMP
 * standard.
 *
...
public interface XMPDM {
	...
	/**
	 * "An alternative tape name, set via the project window or timecode dialog
	 * in Premiere. If an alternative name has been set and has not been
	 * reverted, that name is displayed."
	 */
	...
	/**
	 * "The audio sample rate. Can be any value, but commonly 32000, 41100, or
	 * 48000."
	 */
	...
	/**
	 * "The musical scale used in the music. 'Neither' is most often used for
	 ...
	 * 'Oktoberfest, Munich, Germany'. For more accurate positioning, use the
	 * EXIF GPS values."
	 */
	...
	// */
	// Property VIDEO_ALPHA_PREMULTIPLE_COLOR =
	...
	/**
	 * "The size in bits of each color component of a pixel. Standard Windows
	 * 32-bit pixels have 8 bits per component."
	 */
