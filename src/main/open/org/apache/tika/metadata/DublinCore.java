...
public interface DublinCore {
	 ...
	 */
	Property FORMAT = Property.internalText(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "format");
	 ...
	 */
	Property IDENTIFIER = Property.internalText(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "identifier");

	/**
	 * Date on which the resource was changed.
	 */
	Property MODIFIED = Property.internalDate(PREFIX_DC_TERMS + Metadata.NAMESPACE_PREFIX_DELIMITER + "modified");
	 ...
	 * indicate the entity.
	 */
	Property CONTRIBUTOR = Property.internalTextBag(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "contributor");
	 ...
	 */
	Property COVERAGE = Property.internalText(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "coverage");
	 ...
	 */
	Property CREATOR = Property.internalTextBag(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "creator");

	/**
	 * Date of creation of the resource.
	 */
	Property CREATED = Property.internalDate(PREFIX_DC_TERMS + Metadata.NAMESPACE_PREFIX_DELIMITER + "created");
	 ...
	 * format.
	 */
	Property DATE = Property.internalDate(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "date");
	 ...
	 */
	Property DESCRIPTION = Property.internalText(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "description");
	 ...
	 */
	Property LANGUAGE = Property.internalText(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "language");
	 ...
	 */
	Property PUBLISHER = Property.internalText(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "publisher");
	 ...
	 */
	Property RELATION = Property.internalText(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "relation");
	 ...
	 */
	Property RIGHTS = Property.internalText(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "rights");
	 ...
	 */
	Property SOURCE = Property.internalText(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "source");
	 ...
	 */
	Property SUBJECT = Property.internalTextBag(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "subject");

	/**
	 * A name given to the resource. Typically, a Title will be a name by which
	 * the resource is formally known.
	 */
	Property TITLE = Property.internalText(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "title");
	 ...
	 * the Format element.
	 */
	Property TYPE = Property.internalText(PREFIX_DC + Metadata.NAMESPACE_PREFIX_DELIMITER + "type");
