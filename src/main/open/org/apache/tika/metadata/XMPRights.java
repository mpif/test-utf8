 ...
 * 
 * A collection of property constants for the rights management properties
 * defined in the XMP standard.
 * 
...
public interface XMPRights {
	...
	/**
	 * When true, indicates that this is a rights-managed resource. When false,
	 * indicates that this is a public-domain resource. Omit if the state is
	 * unknown.
	 */
	 ...
	 * userdefined collection. TODO This is actually a language alternative
	 * property
	 */
	Property USAGE_TERMS = Property.internalText(PREFIX_ + "UsageTerms");

	/**
	 * A Web URL for a statement of the ownership and usage rights for this
	 * resource.
	 */
