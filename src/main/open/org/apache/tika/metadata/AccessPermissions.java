...
/**
 * Until we can find a common standard, we'll use these options. They were
 * mostly derived from PDFBox's AccessPermission, but some can apply to other
 * document formats, especially CAN_MODIFY and FILL_IN_FORM.
 */
