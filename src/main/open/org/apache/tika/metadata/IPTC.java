 ...
 * 
 * A collection of {@link Property property definition} constants for the photo
 * metadata properties defined in the IPTC standard.
 * 
 * @since Apache Tika 1.1
 * @see <a href=
 *      "http://www.iptc.org/std/photometadata/specification/IPTC-PhotoMetadata-201007_1.pdf">
 *      IPTC Photo Metadata</a>
 */
public interface IPTC {
	...
	/**
	 * Name of the city the content is focussing on -- either the place shown in
	 * visual media or referenced by text or audio media. This element is at the
	 * third level of a top-down geographical hierarchy.
	 * <p>
	...
	Property COUNTRY_CODE = Property
			.internalText(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "CountryCode");
	 ...
	 * with this property must abide to the processing rules for Lang Alt value
	 * type as specified by the XMP specifications.
	 * <p>
	...
	Property INTELLECTUAL_GENRE = Property
			.internalText(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "IntellectualGenre");

	/**
	 * Keywords to express the subject of the content. Keywords may be free text
	 * and don't have to be taken from a controlled vocabulary. Codes from the
	 * controlled vocabulary IPTC Subject NewsCodes must go to the
	 * "Subject Code" field.
	 * <p>
	 * Single values of this field should not be restricted to single words but
	 * must allow for phrases as well.
	 * <p>
	...
	/**
	 * Describes the scene of a news content. Specifies one or more terms from
	 * the IPTC "Scene-NewsCodes". Each Scene is represented as a string of 6
	 ...
	 */
	Property SCENE_CODE = Property.internalTextBag(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "Scene");
	 ...
	 * free text has to be put into the Keyword element. More about IPTC
	 * Subject-NewsCodes at www.newscodes.org.
	 */
	Property SUBJECT_CODE = Property
			.internalTextBag(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "SubjectCode");

	/**
	 * Name of a sublocation the content is focussing on -- either the location
	 * shown in visual media or referenced by text or audio media. This location
	 * name could either be the name of a sublocation to a city or the name of a
	 * well known location or (natural) monument outside a city. In the sense of
	 * a sublocation to a city this element is at the fourth level of a top-down
	 ...
	 */
	Property SUBLOCATION = Property.internalText(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "Location");
	 ...
	 * merged to this element. Note 2: Implementers are encouraged to provide
	 * the creation date and time from the EXIF data of a digital camera to the
	 * user for entering this date for the first time.
	 * <p>
	 ...
	 * provider of the news object and finally added by the creator to this
	 * field.
	 * <p>
	 ...
	 * element. Note 2: the XMP property (dc:title) which stores the value of
	 ...
	 * this property must abide to the processing rules for Lang Alt value type
	 * as specified by the XMP specifications.
	 * <p>
	 ...
	 * contact information" should be shown as group on the form. Note 2: the
	...
	Property CREATORS_CONTACT_INFO = Property
			.internalText(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "CreatorContactInfo");
	 ...
	 * the copyrights of this image other rights properties may be used. Note 2:
	 ...
	 * "Contact information" group on the form. Note 2: the ContactInfo naming
	 * aligns with the vCard specification RFC 2426.
	 */
	Property CONTACT_INFO_ADDRESS = Property
			.internalTextBag(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "CiAdrExtadr");
	...
	Property CONTACT_INFO_CITY = Property
			.internalText(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "CiAdrCity");
	...
	Property CONTACT_INFO_COUNTRY = Property
			.internalText(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "CiAdrCtry");
	 ...
	 * <p>
	 * Note 1: to user interface implementers: This field should be part of a
	 * "Contact information" group on the form. Note 2 to user interface
	 * implementers: provide sufficient space to fill in multiple e-mail
	 * addresses. Note 3: the ContactInfo naming aligns with the vCard
	 * specification RFC 2426.
	 */
	Property CONTACT_INFO_EMAIL = Property
			.internalTextBag(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "CiEmailWork");

	/**
	 * The contact information phone number part.
	 * <p>
	 * Multiple numbers can be given. May have to be separated by a comma in the
	 * user interface.
	 * <p>
	 * Note 1: to user interface implementers: This field should be part of a
	 * "Contact information" group on the form. Note 2 to user interface
	 * implementers: provide sufficient space to fill in multiple international
	 * numbers. Note 3: the ContactInfo naming aligns with the vCard
	 * specification RFC 2426.
	 */
	Property CONTACT_INFO_PHONE = Property
			.internalTextBag(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "CiTelWork");
	...
	Property CONTACT_INFO_POSTAL_CODE = Property
			.internalText(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "CiAdrPcode");

	/**
	 * The contact information part denoting regional information such as state
	 * or province.
	 * <p>
	 * Note 1: to user interface implementers: This field should be part of a
	 * "Contact information" group on the form. Note 2: the ContactInfo naming
	...
	Property CONTACT_INFO_STATE_PROVINCE = Property
			.internalText(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "CiAdrRegion");
	 ...
	 * Note 1: to user interface implementers: This field should be part of a
	 * "Contact information" group on the form. Note 2 to user interface
	 * implementers: provide sufficient space to fill in multiple URLs. Note 3:
	 * the ContactInfo naming aligns with the vCard specification RFC 2426.
	 */
	Property CONTACT_INFO_WEB_URL = Property
			.internalTextBag(PREFIX_IPTC_CORE + Metadata.NAMESPACE_PREFIX_DELIMITER + "CiUrlWork");
	...
	Property ADDITIONAL_MODEL_INFO = Property
			.internalText(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "AddlModelInfo");

	/**
	 * A set of metadata about artwork or an object in the item
	 */
	Property ARTWORK_OR_OBJECT = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "ArtworkOrObject");

	/**
	 * A set of metadata about artwork or an object in the item
	 */
	Property ORGANISATION_CODE = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "OrganisationInImageCode");
	...
	Property CONTROLLED_VOCABULARY_TERM = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "CVterm");
	...
	Property LOCATION_SHOWN = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationShown");
	 ...
	 */
	Property MODEL_AGE = Property.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "ModelAge");
	 ...
	 */
	Property ORGANISATION_NAME = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "OrganisationInImageName");

	/**
	 * Name of a person the content of the item is about. For photos that is a
	 * person shown in the image.
	 */
	Property PERSON = Property.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "PersonInImage");
	 ...
	 * IPTC's basic requirements for unique ids are: - It must be globally
	 * unique. Algorithms for this purpose exist. - It should identify the
	 * camera body. - It should identify each individual photo from this camera
	 * body. - It should identify the date and time of the creation of the
	 * picture. - It should be secured against tampering. This field should be
	 * implemented in a way to prove it has not been changed since its value has
	...
	Property DIGITAL_IMAGE_GUID = Property
			.internalText(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "DigImageGUID");
	...
	Property DIGITAL_SOURCE_FILE_TYPE = Property
			.internalText(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "DigitalSourcefileType");

	/**
	 * The type of the source of this digital image
	 */
	Property DIGITAL_SOURCE_TYPE = Property
			.internalText(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "DigitalSourceType");
	 ...
	 */
	Property EVENT = Property.internalText(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "Event");
	...
	Property IMAGE_REGISTRY_ENTRY = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "RegistryId");
	...
	Property IMAGE_SUPPLIER = Property
			.internalText(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "ImageSupplier");
	...
	Property IMAGE_SUPPLIER_ID = Property.composite(
			Property.internalText(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "ImageSupplierID"),
			new Property[] { Property.internalText(IPTC.IMAGE_SUPPLIER_ID_WRONG_CASE) });

	/** @deprecated use {@link IPTC#IMAGE_SUPPLIER_ID} */
	public static final String IMAGE_SUPPLIER_ID_WRONG_CASE = PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER
			+ "ImageSupplierId";
	...
	Property IMAGE_SUPPLIER_NAME = Property
			.internalText(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "ImageSupplierName");
	...
	Property IMAGE_SUPPLIER_IMAGE_ID = Property
			.internalText(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "ImageSupplierImageID");
	...
	Property IPTC_LAST_EDITED = Property
			.internalDate(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "IptcLastEdited");
	...
	Property LOCATION_CREATED = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationCreated");
	...
	Property MAX_AVAIL_HEIGHT = Property
			.internalInteger(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "MaxAvailHeight");
	...
	Property MAX_AVAIL_WIDTH = Property
			.internalInteger(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "MaxAvailWidth");
	 ...
	 */
	Property PLUS_VERSION = Property.internalText(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "Version");
	...
	Property COPYRIGHT_OWNER = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "CopyrightOwner");
	...
	Property COPYRIGHT_OWNER_ID = Property.composite(
			Property.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "CopyrightOwnerID"),
			new Property[] { Property.internalTextBag(IPTC.COPYRIGHT_OWNER_ID_WRONG_CASE) });

	/** @deprecated use {@link IPTC#COPYRIGHT_OWNER_ID} */
	public static final String COPYRIGHT_OWNER_ID_WRONG_CASE = PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER
			+ "CopyrightOwnerId";
	...
	Property COPYRIGHT_OWNER_NAME = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "CopyrightOwnerName");
	...
	Property IMAGE_CREATOR = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "ImageCreator");
	...
	Property IMAGE_CREATOR_ID = Property.composite(
			Property.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "ImageCreatorID"),
			new Property[] { Property.internalTextBag(IPTC.IMAGE_CREATOR_ID_WRONG_CASE) });

	/** @deprecated use {@link IPTC#IMAGE_CREATOR_ID} */
	public static final String IMAGE_CREATOR_ID_WRONG_CASE = PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER
			+ "ImageCreatorId";
	...
	Property IMAGE_CREATOR_NAME = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "ImageCreatorName");
	 ...
	 * schema.
	 */
	Property LICENSOR = Property.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "Licensor");

	/**
	 * The ID of the person or company that should be contacted to obtain a
	 * licence for using the item or who has licensed the item.
	 * <p>
	 * This is a PLUS version 1.2 property included in the IPTC Extension
	 * schema.
	 */
	Property LICENSOR_ID = Property.composite(
			Property.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "LicensorID"),
			new Property[] { Property.internalTextBag(IPTC.LICENSOR_ID_WRONG_CASE) });

	/** @deprecated use {@link IPTC#LICENSOR_ID} */
	public static final String LICENSOR_ID_WRONG_CASE = PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER
			+ "LicensorId";

	/**
	 * The name of the person or company that should be contacted to obtain a
	 * licence for using the item or who has licensed the item.
	 * <p>
	 * This is a PLUS version 1.2 property included in the IPTC Extension
	 * schema.
	...
	Property LICENSOR_NAME = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "LicensorName");

	/**
	 * The city of a person or company that should be contacted to obtain a
	 * licence for using the item or who has licensed the item.
	 * <p>
	 * This is a PLUS version 1.2 property included in the IPTC Extension
	 * schema.
	...
	Property LICENSOR_CITY = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "LicensorCity");

	/**
	 * The country of a person or company that should be contacted to obtain a
	 * licence for using the item or who has licensed the item.
	 * <p>
	 * This is a PLUS version 1.2 property included in the IPTC Extension
	 * schema.
	...
	Property LICENSOR_COUNTRY = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "LicensorCountry");

	/**
	 * The email of a person or company that should be contacted to obtain a
	 * licence for using the item or who has licensed the item.
	 * <p>
	 * This is a PLUS version 1.2 property included in the IPTC Extension
	 * schema.
	...
	Property LICENSOR_EMAIL = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "LicensorEmail");

	/**
	 * The extended address of a person or company that should be contacted to
	 * obtain a licence for using the item or who has licensed the item.
	 * <p>
	 * This is a PLUS version 1.2 property included in the IPTC Extension
	 * schema.
	 */
	Property LICENSOR_EXTENDED_ADDRESS = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "LicensorExtendedAddress");

	/**
	 * The postal code of a person or company that should be contacted to obtain
	 * a licence for using the item or who has licensed the item.
	 * <p>
	 * This is a PLUS version 1.2 property included in the IPTC Extension
	 * schema.
	 */
	Property LICENSOR_POSTAL_CODE = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "LicensorPostalCode");

	/**
	 * The region of a person or company that should be contacted to obtain a
	 * licence for using the item or who has licensed the item.
	 * <p>
	 * This is a PLUS version 1.2 property included in the IPTC Extension
	 * schema.
	...
	Property LICENSOR_REGION = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "LicensorRegion");

	/**
	 * The street address of a person or company that should be contacted to
	 * obtain a licence for using the item or who has licensed the item.
	 * <p>
	 * This is a PLUS version 1.2 property included in the IPTC Extension
	 * schema.
	...
	Property LICENSOR_STREET_ADDRESS = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "LicensorStreetAddress");

	/**
	 * The phone number of a person or company that should be contacted to
	 * obtain a licence for using the item or who has licensed the item.
	 * <p>
	 * This is a PLUS version 1.2 property included in the IPTC Extension
	 * schema.
	...
	Property LICENSOR_TELEPHONE_1 = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "LicensorTelephone1");
	...
	Property LICENSOR_TELEPHONE_2 = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "LicensorTelephone2");

	/**
	 * The URL of a person or company that should be contacted to obtain a
	 * licence for using the item or who has licensed the item.
	 * <p>
	 * This is a PLUS version 1.2 property included in the IPTC Extension
	 * schema.
	 */
	Property LICENSOR_URL = Property.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "LicensorURL");
	 ...
	 * the like. But it may be used by image repositories in a B2B enviroment.
	 * <p>
	 * This is a PLUS version 1.2 property included in the IPTC Extension
	 * schema.
	 */
	Property MINOR_MODEL_AGE_DISCLOSURE = Property
			.internalText(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "MinorModelAgeDisclosure");
	...
	Property MODEL_RELEASE_ID = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "ModelReleaseID");
	...
	Property MODEL_RELEASE_STATUS = Property
			.internalText(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "ModelReleaseStatus");
	...
	Property PROPERTY_RELEASE_ID = Property
			.internalTextBag(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "PropertyReleaseID");
	...
	Property PROPERTY_RELEASE_STATUS = Property
			.internalText(PREFIX_PLUS + Metadata.NAMESPACE_PREFIX_DELIMITER + "PropertyReleaseStatus");
	...
	Property ARTWORK_OR_OBJECT_DETAIL_COPYRIGHT_NOTICE = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "AOCopyrightNotice");

	/**
	 * Contains the name of the artist who has created artwork or an object in
	 * the image.
	 */
	Property ARTWORK_OR_OBJECT_DETAIL_CREATOR = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "AOCreator");
	...
	Property ARTWORK_OR_OBJECT_DETAIL_DATE_CREATED = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "AODateCreated");
	...
	Property ARTWORK_OR_OBJECT_DETAIL_SOURCE = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "AOSource");
	...
	Property ARTWORK_OR_OBJECT_DETAIL_SOURCE_INVENTORY_NUMBER = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "AOSourceInvNo");

	/**
	 * A reference for the artwork or object in the image.
	 */
	Property ARTWORK_OR_OBJECT_DETAIL_TITLE = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "AOTitle");
	...
	Property LOCATION_SHOWN_CITY = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationShownCity");
	 ...
	 */
	Property LOCATION_SHOWN_COUNTRY_CODE = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationShownCountryCode");

	/**
	 * The name of a country of a location. This element is at the second level
	 * of a top-down geographical hierarchy.
	 */
	Property LOCATION_SHOWN_COUNTRY_NAME = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationShownCountryName");
	 ...
	 * hierarchy.
	 */
	Property LOCATION_SHOWN_PROVINCE_OR_STATE = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationShownProvinceState");
	 ...
	 */
	Property LOCATION_SHOWN_SUBLOCATION = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationShownSublocation");

	/**
	 * The name of a world region of a location. This element is at the first
	 * (topI) level of a top- down geographical hierarchy.
	 */
	Property LOCATION_SHOWN_WORLD_REGION = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationShownWorldRegion");
	...
	Property LOCATION_CREATED_CITY = Property
			.internalText(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationCreatedCity");
	 ...
	 * scheme as no explicit indication can be provided.
	 */
	Property LOCATION_CREATED_COUNTRY_CODE = Property
			.internalText(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationCreatedCountryCode");

	/**
	 * The name of a country of a location. This element is at the second level
	 * of a top-down geographical hierarchy.
	 */
	Property LOCATION_CREATED_COUNTRY_NAME = Property
			.internalText(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationCreatedCountryName");
	 ...
	 * hierarchy.
	 */
	Property LOCATION_CREATED_PROVINCE_OR_STATE = Property
			.internalText(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationCreatedProvinceState");
	 ...
	 * element is at the fifth level of a top-down geographical hierarchy.
	 */
	Property LOCATION_CREATED_SUBLOCATION = Property
			.internalText(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationCreatedSublocation");

	/**
	 * The name of a world region of a location. This element is at the first
	 * (topI) level of a top- down geographical hierarchy.
	 */
	Property LOCATION_CREATED_WORLD_REGION = Property
			.internalText(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "LocationCreatedWorldRegion");
	...
	Property REGISTRY_ENTRY_CREATED_ITEM_ID = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "RegItemId");

	/**
	 * An identifier for the registry which issued the corresponding Registry
	 * Image Id.
	 */
	Property REGISTRY_ENTRY_CREATED_ORGANISATION_ID = Property
			.internalTextBag(PREFIX_IPTC_EXT + Metadata.NAMESPACE_PREFIX_DELIMITER + "RegOrgId");
