...
public interface XMP {
	...
	/**
	 * The date and time the resource was created. For a digital file, this need
	 * not match a file-system creation time. For a freshly created resource, it
	 * should be close to that time, modulo the time taken to write the file.
	 * Later file transfer, copying, and so on, can make the file-system time
	 ...
	 * xmpidq:Scheme (see 8.7, “xmpidq namespace”) to denote the formal
	 ...
	 * range [0..5], where -1 indicates “rejected” and 0 indicates “unrated”. If
	 * xmp:Rating is not present, a value of 0 should be assumed.
	 */
