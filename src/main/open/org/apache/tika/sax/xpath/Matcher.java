...
/**
 * XPath element matcher. A matcher instance encapsulates a specific state in
 * XPath evaluation.
 */
public class Matcher {

	/**
	 * State of a failed XPath evaluation, where nothing is matched. This
	 * matcher instance is used as a sentinel object whenever an XPath
	 * evaluation branch fails.
	 */
	public static final Matcher FAIL = new Matcher();

	/**
	 * Returns the XPath evaluation state that results from descending to a
	 * child element with the given name.
	 *
	 * @param namespace
	 *            element namespace or <code>null</code>
	 * @param name
	 *            element name
	...
	/**
	 * Returns <code>true</code> if the XPath expression matches the element
	...
	/**
	 * Returns <code>true</code> if the XPath expression matches all text nodes
	 * whose parent is the element associated with this evaluation state.
	 *
