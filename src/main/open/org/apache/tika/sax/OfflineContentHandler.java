 ...
 * {@link #resolveEntity(String, String)} method to prevent potential network or
 * other external resources from being accessed by an XML parser.
 *
...
public class OfflineContentHandler extends ContentHandlerDecorator {
	...
	/**
	 * Returns an empty stream. This will make an XML parser silently ignore any
	 * external entities.
	 */
	@Override
