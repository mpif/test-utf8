...
public class ToTextContentHandler extends DefaultHandler {
	...
	/**
	 * Creates a content handler that writes character events to the given
	 * output stream using the platform default encoding.
	 *
	 * @param stream
	 *            output stream
	 */
	...
	/**
	 * Creates a content handler that writes character events to the given
	 * output stream using the given encoding.
	 *
	 * @param stream
	 *            output stream
	 * @param encoding
	...
	/**
	 * Writes the given ignorable characters to the given character stream. The
	 * default implementation simply forwards the call to the
	...
	/**
	 * Flushes the character stream so that no characters are forgotten in
	 * internal buffers.
	 *
	 * @see <a href="https://issues.apache.org/jira/browse/TIKA-179">TIKA-179
	 *      </a>
	 * @throws SAXException
	 *             if the stream can not be flushed
	 */
	@Override
	...
	/**
	 * Returns the contents of the internal string buffer where all the received
	 * characters have been collected. Only works when this object was
	 * constructed using the empty default constructor or by passing a
	 * {@link StringWriter} to the other constructor.
	 */
	@Override
