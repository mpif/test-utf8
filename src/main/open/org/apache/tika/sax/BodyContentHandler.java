...
/**
 * Content handler decorator that only passes everything inside the XHTML
 * &lt;body/&gt; tag to the underlying handler. Note that the &lt;body/&gt; tag
 * itself is <em>not</em> passed on.
 */
public class BodyContentHandler extends ContentHandlerDecorator {
	...
	/**
	 * Creates a content handler that passes all XHTML body events to the given
	...
	/**
	 * Creates a content handler that writes XHTML body character events to the
	 * given writer.
	 *
	 * @param writer
	 *            writer
	...
	/**
	 * Creates a content handler that writes XHTML body character events to the
	 * given output stream using the default encoding.
	 *
	 * @param stream
	 *            output stream
	 */
	...
	/**
	 * Creates a content handler that writes XHTML body character events to an
	 * internal string buffer. The contents of the buffer can be retrieved using
