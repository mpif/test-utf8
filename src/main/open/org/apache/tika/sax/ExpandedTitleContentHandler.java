...
/**
 * Content handler decorator which wraps a {@link TransformerHandler} in order
 * to allow the <code>TITLE</code> tag to render as
 * <code>&lt;title&gt;&lt;/title&gt;</code> rather than
 * <code>&lt;title/&gt;</code> which is accomplished by calling the
 * {@link TransformerHandler#characters(char[], int, int)} method with a
 * <code>length</code> of 1 but a zero length char array.
 * <p>
 * This workaround is an unfortunate circumstance of the limitations imposed by
 * the implementation of the XML serialization code in the JDK brought over from
