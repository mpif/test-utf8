 ...
 * handler that caused the exception can easily be identified. This is done by
 * using the {@link TaggedSAXException} class to wrap all thrown
...
public class TaggedContentHandler extends ContentHandlerDecorator {
	 ...
	 * original wrapped exception. Returns normally if the exception was not
