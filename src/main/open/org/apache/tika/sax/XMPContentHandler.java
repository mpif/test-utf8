...
public class XMPContentHandler extends SafeContentHandler {
	...
	/**
	 * Starts an XMP document by setting up the namespace mappings and writing
	 * out the following header:
	 * 
	 * <pre>
	 * &lt;rdf:RDF&gt;
	 * </pre>
	...
	/**
	 * Ends the XMP document by writing the following footer and clearing the
	 * namespace mappings:
	 * 
	 * <pre>
	 * &lt;/rdf:RDF&gt;
