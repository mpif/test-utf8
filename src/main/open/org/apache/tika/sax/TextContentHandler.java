 ...
 * {@link #characters(char[], int, int)} and (@link
 * {@link #ignorableWhitespace(char[], int, int)} (plus {@link #startDocument()}
 * and {@link #endDocument()} events to the decorated content handler.
 */
