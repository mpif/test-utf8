 ...
 * <code>Map</code>. Not mappable elements are not forwarded. Attributes may
 * also be mapped (for each element different using a <code>Map</code> for
 * attributes), not mappable attributes are not forwarded. The default is to not
 * map any attributes and therefore do not forward any of them.
 */
public class ElementMappingContentHandler extends ContentHandlerDecorator {
	...
	public static class TargetElement {
		...
		/**
		 * Creates an TargetElement, attributes of this element will be mapped
		 * as specified
		 */
		...
		/**
		 * Creates an TargetElement with no attributes, all attributes will be
		 * deleted from SAX stream
		 */
