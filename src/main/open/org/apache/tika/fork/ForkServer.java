...
class ForkServer implements Runnable, Checksum {
	 ...
	 * streams for communication with the parent process. Any attempts by stray
	 * code to read from standard input or write to standard output is
	 * redirected to avoid interfering with the communication channel.
	 * 
	 * @param args
	...
	public void processRequests() {
		try {
			...
			ClassLoader loader = (ClassLoader) readObject(ForkServer.class.getClassLoader());
