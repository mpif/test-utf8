...
public class ForkParser extends AbstractParser {
	 ...
	 * @param parser
	 *            the parser to delegate to. This one cannot be another
	 *            ForkParser
	 */
	 ...
	 * "-jar" and "/path/to/bootstrap.jar" are appended to the given command
	...
	/**
	 * Sets the command used to start the forked server process. The given
	 * command line is split on whitespace and the arguments 2 * "-jar" and
	 * "/path/to/bootstrap.jar" are appended to it when starting 2 * the
	 * process. The default setting is "java -Xmx32m".
	 *
	 * @param java
	 *            java command line
	 * @deprecated since 1.8
