 ...
 * embedded document extraction by a {@link ContainerExtractor} instance. An
 * implementation of this interface defines some specific selection criteria to
 * be applied against the document metadata passed to the
