...
/**
 * Tika container extractor interface. Container Extractors provide access to
 * the embedded resources within container formats such as .zip and .doc
 */
public interface ContainerExtractor extends Serializable {
	...
	/**
	 * Processes a container file, and extracts all the embedded resources from
	 * within it.
	 * <p>
	 * The {@link EmbeddedResourceHandler} you supply will be called for each
	 * embedded resource in the container. It is up to you whether you process
	 * the contents of the resource or not.
	 * <p>
	 ...
	 * <p>
	 * If required, nested containers (such as a .docx within a .zip) can
	 * automatically be recursed into, and processed inline. If no
	 * recurseExtractor is given, the nested containers will be treated as with
	 * any other embedded resources.
	 *
	 * @since Apache Tika 0.8
	 * @param stream
	 *            the document stream (input)
	 * @param recurseExtractor
	 *            the extractor to use on any embedded containers
	 * @param handler
