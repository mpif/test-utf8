...
public interface EmbeddedDocumentExtractor {
	...
	/**
	 * Processes the supplied embedded resource, calling the delegating parser
	 ...
	 *            The handler to use
	 * @param metadata
	 *            The metadata for the embedded resource
	 * @param outputHtml
	 *            Should we output HTML for this resource, or has the parser
	 *            already done so?
