 ...
 * {@link Parser} API. This allows you to easily extract out all the embedded
 * resources from within container files supported by normal Tika parsers. By
 * default the {@link AutoDetectParser} will be used, to allow extraction from
 * the widest range of containers.
 */
