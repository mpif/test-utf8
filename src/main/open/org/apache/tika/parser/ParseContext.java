...
public class ParseContext implements Serializable {
	 ...
	 *
	 * @param key
	 *            the interface implemented by the given value
	 * @param value
	 *            the value to be added, or <code>null</code> to remove
	 */
	 ...
	 * @return the object that implements the given interface, or
	 ...
	 * @return the object that implements the given interface, or the given
	...
	/**
	 * Returns the SAX parser specified in this parsing context. If a parser is
	 * not explicitly specified, then one is created using the specified or the
	 ...
	 *             if a SAX parser could not be created
	 */
	...
	/**
	 * Returns the SAX parser factory specified in this parsing context. If a
	 * factory is not explicitly specified, then a default factory instance is
	 * created and returned. The default factory instance is configured to be
	 * namespace-aware and to use {@link XMLConstants#FEATURE_SECURE_PROCESSING
