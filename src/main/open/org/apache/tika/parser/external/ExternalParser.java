...
public class ExternalParser extends AbstractParser {
	...
	/**
	 * Sets the map of regular expression patterns and Metadata keys. Any
	 * matching patterns will have the matching metadata entries set. Set this
	 * to null to disable Metadata extraction.
	 */
