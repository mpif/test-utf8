...
public class AutoDetectParser extends CompositeParser {
	...
	/**
	 * Creates an auto-detecting parser instance using the specified set of
	 * parser. This allows one to create a Tika configuration where only a
	 * subset of the available parsers have their 3rd party jars included, as
	 * otherwise the use of the default TikaConfig will throw various
	...
	/**
	 * Returns the type detector used by this parser to auto-detect the type of
	 * a document.
	 *
