...
/**
 * Parser decorator that post-processes the results from a decorated parser. The
 * post-processing takes care of filling in the "fulltext", "summary", and
 * "outlinks" metadata entries based on the full text content returned by the
 * decorated parser.
 */
public class ParserPostProcessor extends ParserDecorator {
	...
	/**
	 * Forwards the call to the delegated parser and post-processes the results
	 * as described above.
	 */
