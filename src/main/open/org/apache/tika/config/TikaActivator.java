 ...
 * <p>
 * Note that you should <strong>not</strong> access this class directly. Instead
 * the OSGi environment (if present) will automatically invoke the methods of
 * this class based on the Bundle-Activator setting in the bundle manifest.
 *
