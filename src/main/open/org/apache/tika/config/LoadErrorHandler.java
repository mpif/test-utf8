...
/**
 * Interface for error handling strategies in service class loading. You can
 * implement this interface for a custom error handling mechanism, or use one of
...
public interface LoadErrorHandler {
	...
	/**
	 * Handles a problem encountered when trying to load the specified service
	 * class. The implementation can log or otherwise process the given error
	 * information. If the method returns normally, then the service loader
	 * simply skips this class and continues with the next one.
	 *
	 * @param classname
	...
	/**
	 * Strategy that throws a {@link RuntimeException} with the given throwable
	 * as the root cause, thus interrupting the entire service loading
	 * operation.
	 */
