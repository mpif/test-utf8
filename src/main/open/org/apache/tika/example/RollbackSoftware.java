...
public class RollbackSoftware {
	...
	public void rollback(File deployArea) throws IOException, SAXException, TikaException {
		...
		parser.parse(IOUtils.toInputStream(deployArea.getAbsolutePath()), handler, met);
	...
	class DeploymentAreaParser implements Parser {
		...
		public Set<MediaType> getSupportedTypes(ParseContext context) {
			return Collections.unmodifiableSet(new HashSet<MediaType>(Arrays.asList(MediaType.TEXT_PLAIN)));
		}
