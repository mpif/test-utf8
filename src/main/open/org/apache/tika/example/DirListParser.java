...
public class DirListParser implements Parser {
	...
	private static Set<MediaType> SUPPORTED_TYPES = new HashSet<MediaType>(Arrays.asList(MediaType.TEXT_PLAIN));
	...
	public void parse(InputStream is, ContentHandler handler, Metadata metadata, ParseContext context)
		...
		List<String> lines = FileUtils.readLines(TikaInputStream.get(is).getFile());
