...
/**
 * Examples of using different Content Handlers to get different parts of the
 * file's contents
 */
public class ContentHandlerExample {
	/**
	 * Example of extracting the plain text of the contents. Will return only
	...
	/**
	 * Example of extracting just the body as HTML, without the head part, as a
	 * string
	 */
	...
	/**
	 * Example of extracting just one part of the document's body, as HTML as a
	 * string, excluding the rest
	 */
	...
	/**
	 * Example of extracting the plain text in chunks, with each chunk of no
	 * more than a certain maximum size
	 */
