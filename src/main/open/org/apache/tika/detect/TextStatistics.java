...
public class TextStatistics {
	...
	/**
	 * Checks whether at least one byte was seen and that the bytes that were
	 * seen were mostly plain text (i.e. < 2% control, > 90% ASCII range).
	 *
	 * @see <a href="https://issues.apache.org/jira/browse/TIKA-483">TIKA-483
	 *      </a>
	 * @see <a href="https://issues.apache.org/jira/browse/TIKA-688">TIKA-688
	 *      </a>
	...
	public boolean looksLikeUTF8() {
		...
		return utf8 > 0 && continuation <= expectedContinuation && continuation >= expectedContinuation - 3
				&& count(0xf80, 0x100) == 0 && (control - safe) * 100 < utf8 * 2;
	}
	...
	/**
	 * Counts control characters (i.e. < 0x20, excluding tab, CR, LF, page feed
	 * and escape).
	 * <p>
	 ...
	 * </pre>
	 *
	 * @see <a href="https://issues.apache.org/jira/browse/TIKA-154">TIKA-154
	 *      </a>
