...
/**
 * An input stream reader that automatically detects the character encoding to
 * be used for converting bytes to characters.
 *
...
public class AutoDetectReader extends BufferedReader {
	...
	private static Charset detect(InputStream input, Metadata metadata, List<EncodingDetector> detectors,
	...
	private AutoDetectReader(BufferedInputStream stream, Metadata metadata, List<EncodingDetector> detectors,
			LoadErrorHandler handler) throws IOException, TikaException {
