...
/**
 * A version of {@link DefaultDetector} for probabilistic mime detectors, which
 * use statistical techniques to blend the results of differing underlying
 * detectors when attempting to detect the type of a given file. TODO Link to
 * documentation on configuring these probabilities
 */
