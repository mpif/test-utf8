...
/**
 * Exception to be thrown when a document does not allow content extraction. As
 * of this writing, PDF documents are the only type of document that might cause
