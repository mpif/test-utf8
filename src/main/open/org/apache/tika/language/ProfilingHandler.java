...
/**
 * SAX content handler that builds a language profile based on all the received
 * character content.
 *
...
public class ProfilingHandler extends WriteOutContentHandler {
	...
	/**
	 * Returns the language profile being built by this content handler. Note
	 * that the returned profile gets updated whenever new SAX events are
	 * received by this content handler. Use the {@link #getLanguage()} method
	 * to get the language that best matches the current state of the profile.
	 *
	...
	/**
	 * Returns the language that best matches the current state of the language
	 * profile.
	 *
