 ...
 * <p>
 * This class provides static utility methods for input/output operations on
 * numbers in Big and Little Endian formats.
 * <p>
...
public class EndianUtils {
	...
	public static long readLongLE(InputStream stream) throws IOException, BufferUnderrunException {
		...
		return ((long) ch8 << 56) + ((long) ch7 << 48) + ((long) ch6 << 40) + ((long) ch5 << 32) + ((long) ch4 << 24) + // cast
																														// to
																														// long
																														// to
																														// preserve
	...
	public static long readLongBE(InputStream stream) throws IOException, BufferUnderrunException {
		...
		return ((long) ch1 << 56) + ((long) ch2 << 48) + ((long) ch3 << 40) + ((long) ch4 << 32) + ((long) ch5 << 24) + // cast
																														// to
																														// long
																														// to
																														// preserve
	...
	/**
	 * Gets the integer value that is stored in UTF-8 like fashion, in Big
	 * Endian but with the high bit on each number indicating if it continues or
	 * not
	 */
