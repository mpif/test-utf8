...
public class FilenameUtils {
	 ...
	 *
	 * For example <code>why?.zip</code> will be converted into
	 * <code>why%3F.zip</code>
	 *
	 * @param name
	 *            the file name to be normalized - NOT NULL
	 *
	...
	/**
	 * This is a duplication of the algorithm and functionality available in
	 * commons io FilenameUtils. If Java's File were able handle Windows file
	 * paths correctly in linux, we wouldn't need this.
	 * <p>
	 * The goal of this is to get a filename from a path. The package parsers
	 * and some other embedded doc extractors could put anything into
	 * Metadata.RESOURCE_NAME_KEY.
	 * <p>
	 * If a careless client used that filename as if it were a filename and not
	 * a path when writing embedded files, bad things could happen. Consider:
	 * "../../../my_ppt.ppt".
	 * <p>
