...
public class TemporaryResources implements Closeable {
	 ...
	 *
	 * @param tmp
	 *            temporary file directory, or <code>null</code> for the system
	 *            default
	 */
	 ...
	 *
	 * @throws IOException
	 *             if one or more of the tracked resources could not be closed
	 */
	public void close() throws IOException {
	 ...
	 * {@link IOException} into a {@link TikaException} for convenience when
	 * used within Tika.
	 *
