...
public class ExternalEmbedder implements Embedder {
	...
	public void embed(final Metadata metadata, final InputStream inputStream, final OutputStream outputStream,
		...
		try {
			...
			if (outputFromStdOut) {
				...
				// The command is finished, read the output file into the given
				// output stream
	...
	/**
	 * Creates a new thread for copying a given input stream to a given output
	 * stream.
	 *
	 * @param inputStream
	...
	/**
	 * Sends the contents of the given input stream to the standard input of the
	 * given process. Potential exceptions are ignored.
	 * <p>
	 ...
	 *            the process
	 * @param inputStream
	 *            the input stream to send to standard input of the process
	 */
	...
	/**
	 * Sends the standard output of the given process to the given output
	 * stream. Potential exceptions are ignored.
	 * <p>
	 ...
	 *
	 * @param process
	 *            the process param outputStream the output stream to send to
