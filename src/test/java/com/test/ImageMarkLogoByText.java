...
public class ImageMarkLogoByText {
	...
	public static void main(String[] args) {
		String srcImgPath = "d:/csz/test/image/1.jpg";
		String logoText = "[英达文字水印 http://wangyingda415.com]";
		String targerPath = "d:/csz/test/image/my3.jpg";

		String targerPath2 = "d:/csz/test/image/my4.jpg";
